...
@property(nonatomic, assign) BOOL isCroppingScanArea;
@property(nonatomic, assign) double cropScanAreaPercentageWidth;
@property(nonatomic, assign) double cropScanAreaPercentageHeight;
